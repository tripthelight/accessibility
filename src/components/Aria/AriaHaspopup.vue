<template>
  <div class="aria-haspopup">
    <div>
      ...
      <div role="button" aria-controls="thisPopupWrap" class="btnOpenPopup" @click="popSta">CLICK OPEN POPUP222</div>
      <div id="thisPopupWrap" :class="['popup', popupState?'open':'close']">
